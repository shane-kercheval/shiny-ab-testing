...
```{r}
# goal is to create a dataset containing conversion rates for an experiment
# user_id | variation | first_saw_experiment | metric | attribution window | conversion_date | -> converted
